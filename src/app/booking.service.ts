...
export class BookingService {
  private apiUrl = 'http://localhost:8080/api/bookings/book'; // Replace with actual API URL
  private bookapiUrl = 'http://localhost:8080/api/bookings/user/';
  private getBookingapiUrl='http://localhost:8080/api/bookings/getAllBookings';
